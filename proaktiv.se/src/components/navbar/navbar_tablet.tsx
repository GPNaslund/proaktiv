...
export default function NavBarTablet() {
    return (
        <nav className="fixed top-0 left-0 right-0 grid tablet-lg:grid-cols-4 grid-cols-5 w-full z-20 p-5 bg-white" id="main-grid">
            ...
            <div className="col-span-2 tablet-lg:col-span-1 justify-self-end grid grid-cols-2">
                ...
                <a href="https://system.easypractice.net/book/proaktiv-idrottscenter" target="_blank">
                    <button className= " text-black text-sm font-bold py-2 px-4 rounded-lg border-black border">
                        Boka tid
                    </button>
                </a>
            </div>
